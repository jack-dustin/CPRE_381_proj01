...
--     o_reg_we  <= '1' when (is_rtype='1' or is_itype='1')

--              else '0';
--   -- immediate or register operation
--   -- o_alu_src <= '1' when (is_itype='1' or is_load='1' or is_store='1' or is_jalr='1' or is_u_lui='1' or is_u_auipc='1')
--     o_alu_src <= '1' when (is_itype='1')

--              else '0';
  
--   --load and store enable
--   o_mem_we  <= '1' when is_store='1' else '0';
--   o_mem_re  <= '1' when is_load='1'  else '0';

--   o_is_branch <= is_b;

--   -- Writeback select --TODO
--   o_memtreg <= WB_MEM when is_load='1' else
